...
from teste_vendas import preco

valor = 49.90
preco_com_aumento = preco.preco_aumento(preco=valor, percentual=10, formata=True)
print(preco_com_aumento)
preco_com_aumento = preco.preco_aumento(preco=valor, percentual=10, formata=False)
print(preco_com_aumento)
